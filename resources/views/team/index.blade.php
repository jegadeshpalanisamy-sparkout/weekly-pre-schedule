        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 flex justify-end">
                    <!-- Add Week Button -->
                    <a href="{{ route('add-team') }}" class="inline-block px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">
                        Add Team
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($teams as $team)
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('team.edit', $team->id) }}" class="nline-block px-4 py-2 bg-yellow-500 text-white font-semibold rounded-lg shadow-md hover:bg-yellow-600">Edit</a>
